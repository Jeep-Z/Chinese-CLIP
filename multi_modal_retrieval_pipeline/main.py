...
def torch_version_str_compare_lessequal(*args):
    return True
...
def main():
    ...
    vision_model_config_file = Path(__file__).parent.parent / f"cn_clip/clip/model_configs/{args.vision_model.replace('/', '-')}.json"
    print('Loading vision model config from', vision_model_config_file)
    assert os.path.exists(vision_model_config_file)
    
    text_model_config_file = Path(__file__).parent.parent / f"cn_clip/clip/model_configs/{args.text_model.replace('/', '-')}.json"
